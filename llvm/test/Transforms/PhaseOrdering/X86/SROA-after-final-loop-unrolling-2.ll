...
; CHECK-NEXT:    ret void
; CHECK:       [[BB13]]:
; CHECK-NEXT:    [[I24:%.*]] = phi i32 [ [[I21_3]], %[[BB13]] ], [ 42, %[[BB]] ]
; CHECK-NEXT:    [[I4_05:%.*]] = phi i32 [ [[I21_2]], %[[BB13]] ], [ 24, %[[BB]] ]
...
; CHECK-NEXT:    [[I21_2]] = mul nsw i32 [[I24_1]], [[I21]]
; CHECK-NEXT:    [[I24_2:%.*]] = or disjoint i32 [[I3_SROA_0_0]], 3
; CHECK-NEXT:    [[I21_3]] = mul nsw i32 [[I24_2]], [[I21_1]]
