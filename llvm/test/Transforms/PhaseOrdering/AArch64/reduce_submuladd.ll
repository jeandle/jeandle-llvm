...
; CHECK-NEXT:    [[TMP41:%.*]] = getelementptr inbounds float, ptr [[TMP28]], i64 [[TMP5]]
; CHECK-NEXT:    [[TMP42:%.*]] = getelementptr inbounds float, ptr [[TMP29]], i64 [[TMP4]]
...
; CHECK-NEXT:    [[TMP54:%.*]] = getelementptr inbounds float, ptr [[TMP41]], i64 [[TMP5]]
; CHECK-NEXT:    [[TMP55:%.*]] = getelementptr inbounds float, ptr [[TMP42]], i64 [[TMP4]]
...
; CHECK-NEXT:    [[TMP67:%.*]] = getelementptr inbounds float, ptr [[TMP54]], i64 [[TMP5]]
; CHECK-NEXT:    [[TMP68:%.*]] = getelementptr inbounds float, ptr [[TMP55]], i64 [[TMP4]]
...
; CHECK-NEXT:    [[TMP80:%.*]] = getelementptr inbounds float, ptr [[TMP67]], i64 [[TMP5]]
; CHECK-NEXT:    [[TMP81:%.*]] = getelementptr inbounds float, ptr [[TMP68]], i64 [[TMP4]]
