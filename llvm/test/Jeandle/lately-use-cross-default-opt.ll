...
; RUN: opt -S -passes="java-operation-lower<phase=0>,default<O3>,insert-gc-barriers,java-operation-lower<phase=2>,java-operation-deletion" %s 2>&1 | FileCheck -check-prefix=CHECK-ERASE %s
